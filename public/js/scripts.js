...
$(".btn_delete_event").click(function() {
    ...
    Swal.fire({
       ...
       if (result.value) {
           window.location = "/admin/delete_event="+event_id;
       }
    });
})
...
$(".btn_delete_category").click(function() {
    ...
    Swal.fire({
       ...
       if (result.value) {
           window.location = "/admin/delete_category="+cat_id;
       }
    });
})
 ...
 */
 ...
 $(".btn_delete_user").click(function() {
    ...
    Swal.fire({
       ...
       if (result.value) {
           window.location = "/admin/delete_user="+user_id;
       }
    });
 ...
 */
 ...
 $(".btn_delete_customer").click(function() {
    ...
    Swal.fire({
       ...
       if (result.value) {
           window.location = "/admin/delete_customer="+cust_id;
       }
    });
 ...
 */
 ...
 $(".btn_delete_order").click(function() {
    ...
    Swal.fire({
       ...
       if (result.value) {
           window.location = "/admin/delete_order="+order_id;
       }
    });
 ...
 */
 ...
 $(".btn_delete_payement").click(function() {
    ...
    Swal.fire({
       ...
       if (result.value) {
           window.location = "/admin/delete_payment="+payement_id;
       }
    });
 ...
 */
 ...
 $(".btn_delete_slider").click(function() {
    ...
    Swal.fire({
       ...
       if (result.value) {
           window.location = "/admin/delete_slider="+ $slider_id;
       }
    });
